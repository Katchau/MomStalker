 ...
 */
public class AddFriend extends ClientHandler implements HttpHandler {
    public AddFriend(){
        super("user1,user2");
    }
    ...
    public void handle(HttpExchange httpExchange) throws IOException {
        ...
        if(!httpExchange.getRequestMethod().equals("POST")){
            System.err.println("Received bad request @AddFrind");
        ...
        String response = (db.createAmizade(user1, user2)) ? "Success" : "Fail";
        db.closeDB();
