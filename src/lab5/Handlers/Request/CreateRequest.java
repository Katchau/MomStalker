 ...
 */
public class CreateRequest  extends ClientHandler implements HttpHandler {
    ...
    public void handle(HttpExchange httpExchange) throws IOException {
        ...
        if(!httpExchange.getRequestMethod().equals("POST")){
            System.err.println("Received bad request @CreateRequest");
        ...
        String response = (db.createFRequest(user1, user2)) ? "Success" : "Fail";
        db.closeDB();
